...
function write_prop(prop, parent, parent_uuid) {
...
function write_node() {
    ...
    write_prop("guestname", config["parent"]["guestname"], uuids[config["parent"]["guestname"]])

    write_prop("guestdate", config["parent"]["guestdate"], uuids[config["parent"]["guestdate"]])

    write_prop("hostname", config["parent"]["hostname"], uuids[config["parent"]["hostname"]])

    write_prop("hostdate", config["parent"]["hostdate"], uuids[config["parent"]["hostdate"]])

    write_prop("privacy", config["parent"]["privacy"], uuids[config["parent"]["privacy"]])

    write_prop("tag", config["parent"]["tag"], uuids[config["parent"]["tag"]])

    write_prop("filepath", config["parent"]["filepath"], uuids[config["parent"]["filepath"]])

    # TODO replace with (config["parent"][prop] != "")
    if (values["filepath"] != "") {

        write_prop("filesize", config["parent"]["filesize"], uuids[config["parent"]["filesize"]])

        write_prop("filetype", config["parent"]["filetype"], uuids[config["parent"]["filetype"]])

        write_prop("moddate", config["parent"]["moddate"], uuids[config["parent"]["moddate"]])
