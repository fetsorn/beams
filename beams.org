...
function write_node(temp, datum) {
    ...
    if (guestname != "") {
        ...
        system("mkdir -p " temp "/pairs " temp "/props/name")
    ...
    guestdate = trim_timestamp(props["GUEST_DATE"])
    if (guestdate != "") {
        ...
        system("mkdir -p " temp "/pairs " temp "/props/date")
    ...
    hostdate = trim_timestamp(props["HOST_DATE"])
    if (hostdate != "") {
    ...
    if (privacy != "") {
        ...
        system("mkdir -p " temp "/pairs " temp "/props/privacy")
    ...
    if (tag != "") {
        ...
        system("mkdir -p " temp "/pairs " temp "/props/tag")
    ...
    if (filepath != "") {
        ...
        system("mkdir -p " temp "/pairs " temp "/props/filepath")
        ...
        if (filesize != "") {
            ...
            system("mkdir -p " temp "/pairs " temp "/props/filesize")
        ...
        if (filetype != "") {
            ...
            system("mkdir -p " temp "/pairs " temp "/props/filetype")
        ...
        moddate = trim_timestamp(props["MOD_DATE"])
        if (moddate != "") {
